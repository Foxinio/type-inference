...
val lookup_ctor     : t -> Imast.var_type -> (Type.typ * Type.TVarSet.t * Type.typ) option

val extend_delta_with_alias : t -> Type.typ Imast.var -> Type.TVarSet.t -> t
...
val lookup_delta : t -> Imast.var_type -> (Type.typ * Type.TVarSet.t) option
